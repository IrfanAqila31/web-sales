    ...
    <div class="w-full max-w-7xl mx-auto">
      <div class="flex flex-wrap items-center">
        <div class="w-full self-center px-4 lg:w-1/2 order-2 lg:order-1">
          ...
          <p class="text-slate-600 font-medium text-sm md:text-base mb-4 max-w-xl">
            Nikmati koneksi internet cepat dan stabil untuk rumah, bisnis, dan kebutuhan Anda dengan
            harga terjangkau.
          </p>
